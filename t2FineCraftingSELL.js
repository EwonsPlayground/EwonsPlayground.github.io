(function(){
    ...
    const chartHeadings = ["Dust Material", "T1 Material", "T2 Material", "T2 Price", "T1 Price", "Dust Price", "Cost", "T2 Sell"];
    ...
    // Item Name and IDs
    const itemIDArray = [{name: "Bone Shard", id: 24343, materialID: 24342},
                         {name: "Small Claw", id: 24347, materialID: 24346},
                         {name: "Small Fang", id: 24353, materialID: 24352},
                         {name: "Small Scale", id: 24285, materialID: 24284},
                         {name: "Small Totem", id: 24297, materialID: 24296},
                         {name: "Small Venom Sac", id: 24279, materialID: 24278},
                         {name: "Vial of Thin Blood", id: 24291, materialID: 24290}];
    ...
    const calculateProfit = function() {
        ...
        for (var i = 0; i < craftingData.length; i++) {
            ...
            craftingData[i].avgSell = parseFloat((localStorage.getItem("t6avg") * t6SellPrice * 0.85).toFixed(2));
